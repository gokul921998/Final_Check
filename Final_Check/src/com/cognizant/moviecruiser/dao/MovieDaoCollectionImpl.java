...
public class MovieDaoCollectionImpl implements MovieDao {
	...
	public MovieDaoCollectionImpl() {
		...
		if (movieList == null) {
			...
			try {
				movieList.add(new Movie(1, "Avatar", 2787965087f, true,
						DateUtil.convertToDate("15/03/2017"), "ScienceFiction",
						true));

				movieList.add(new Movie(2, "The Avengers", 1518812988f, true,
						DateUtil.convertToDate("23/12/2017"), "Superhero",
						false));

				movieList
						.add(new Movie(3, "Titanic", 21874639444f, true, DateUtil
								.convertToDate("07/02/2017"), "Romance", false));

				movieList.add(new Movie(4, "Hugo", 1671713208f, false,
						DateUtil.convertToDate("09/02/2017"), "ScienceFiction",
						true));

				movieList.add(new Movie(5, "Civil War", 2750760348f,
